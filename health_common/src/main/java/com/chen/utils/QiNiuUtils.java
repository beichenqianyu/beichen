...
public class QiNiuUtils {
    //配置秘钥
    private static final String ACCESSKEY = "j8RqWHjTfQkkCHFRMC5czvMqdEWheEyaW6V3NN2u";
    private static final String SECRETKEY = "EdsSdttU2JeY177qTnO2A7HHwW6WqZLYbyrqrxQg";

    //对象仓库
    private static final String BUCKET = "chenxiaoqing";
    public static final String DOMAIN= "http://qzocdonl4.hn-bkt.clouddn.com/";
